...
class RegularGrid(object):
    ...
    def __init__(self, limits, breaks, values):
        ...
        grid_edges = []
        for limit, break_points in zip(limits, breaks):
    ...
    def __call__(self, *coords):
        ...
        for coord, break_points in zip(coords, self.grid):
        ...
        for edge_indices in edges:
            ...
            for edge_index, index, norm_distance in zip(edge_indices, indices, norm_distances):
