import numpy as np
import pytest
from ittp_interpolation.techniques.nearest_neoghbour import (
...
def test_nearest_neighbor_upscale_grayscale(sample_grayscale_image):
    ...
    scale_factor = 2.0
    result = nearest_neighbor_interpolation(
        sample_grayscale_image, scale_factor
    )
